...
/* In calling a device function, <<<N,1>>> means we will
call N Blocks of parallel processes, in this way we can add
vectors, we can acess diferent block index through blockIdx.x*/
